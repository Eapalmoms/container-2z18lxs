...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-2z18lxs.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-2z18lxs.containers.anotherwebservice.com/
...
```
git clone git@github.com:Eapalmoms/container-2z18lxs.git
cd container-2z18lxs
```
...
```
docker attach container-2z18lxs
```
